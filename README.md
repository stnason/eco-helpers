...
These utility functions are specifically designed to be used with the Eco Framework; an overlay to Laravel.
They work in conjunction with custom views and configuration files to allow easy page and form setup.
