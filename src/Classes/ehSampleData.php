    ...
    */
        ...
        return [
            1=>[
               ...
               */
                ...
                'login_created' => date(ehConfig::get('date_sql_long')),
                'last_login' => null,
                'login_count' => 0,
                'name' => 'ehUser',
                'email' => 'ehUser@email.com',
                'email_verified_at' => date(ehConfig::get('date_sql_long')),
                'password' => Hash::make('ehUser'),
                'created_by'=>'system',
                'created_at'=>date(ehConfig::get('date_sql_long')),
                'updated_by'=>'system',
                'updated_at'=>date(ehConfig::get('date_sql_long')),
            ],
            2=>[
                'archived' => 0,
                'first_name' => 'eh',
    ...
    protected static function pagesData() {
        return [
            ...
            ['id'=>'8','name'=>'System Settings','alt_text'=>'system settings and configuration','description'=>'system settings and configuration','type'=>'resource','active'=>'1','security'=>'3','icon'=>'fa-solid fa-gear','parent_id'=>'1','menu_item'=>'1','order'=>'4','route'=>'settings','feature_1'=>'','feature_2'=>'','feature_3'=>'','feature_4'=>'','comment'=>'','created_by'=>'system','created_at'=>date('Y-m-d'),'updated_by'=>'system','updated_at'=>date('Y-m-d')],
