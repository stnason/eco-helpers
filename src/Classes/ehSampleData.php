    ...
    */
    ...
    protected static function pagesData() {
        return [
            ...
            ['id'=>'5',	'name'=>'Menus/ Pages',	'alt_text'=>'create and maintain menus and page security',	'description'=>'create and maintain menus and page security',	'type'=>'resource',	'active'=>'1',	'security'=>'3',	'icon'=>'fa-regular fa-rectangle-list',	'parent_id'=>'1',	'menu_item'=>'1',	'order'=>'3',	'route'=>'pages.index',	'feature_1'=>'',	'feature_2'=>'',	'feature_3'=>'',	'feature_4'=>'',	'comment'=>'',	'created_by'=>'system',	'created_at'=>date('Y-m-d'),	'updated_by'=>'system',	'updated_at'=>date('Y-m-d')],
            ['id'=>'6',	'name'=>'Roles',	'alt_text'=>'define user security roles',	'description'=>'define user security roles',	'type'=>'resource',	'active'=>'1',	'security'=>'3',	'icon'=>'fa-solid fa-users-between-lines',	'parent_id'=>'1',	'menu_item'=>'1',	'order'=>'2',	'route'=>'roles.index',	'feature_1'=>'',	'feature_2'=>'',	'feature_3'=>'',	'feature_4'=>'',	'comment'=>'',	'created_by'=>'system',	'created_at'=>date('Y-m-d'),	'updated_by'=>'system',	'updated_at'=>date('Y-m-d')],
            ['id'=>'7',	'name'=>'Users',	'alt_text'=>'maintain individual user information',	'description'=>'maintain individual user information',	'type'=>'resource',	'active'=>'1',	'security'=>'3',	'icon'=>'fa-regular fa-user',	'parent_id'=>'1',	'menu_item'=>'1',	'order'=>'1',	'route'=>'users.index',	'feature_1'=>'',	'feature_2'=>'',	'feature_3'=>'',	'feature_4'=>'',	'comment'=>'',	'created_by'=>'system',	'created_at'=>date('Y-m-d'),	'updated_by'=>'system',	'updated_at'=>date('Y-m-d')],
            ['id'=>'8',	'name'=>'System Settings',	'alt_text'=>'system settings and configuration',	'description'=>'system settings and configuration',	'type'=>'resource',	'active'=>'1',	'security'=>'3',	'icon'=>'fa-solid fa-gear',	'parent_id'=>'1',	'menu_item'=>'1',	'order'=>'4',	'route'=>'config.index',	'feature_1'=>'',	'feature_2'=>'',	'feature_3'=>'',	'feature_4'=>'',	'comment'=>'',	'created_by'=>'system',	'created_at'=>date('Y-m-d'),	'updated_by'=>'system',	'updated_at'=>date('Y-m-d')],
