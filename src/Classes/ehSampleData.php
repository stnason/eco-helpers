...
class ehSampleData {
    ...
    public static function createSampleData() {
        ...
        // xx. Create the ehSettings sample data.
        // ehSampleData::createSettings(self::settingData()[1]);
        // OOTB startup data is already being generated in the ehConfig class.

        // xx. Load the ehNotifications sample data.
        //     This is just a scratch pag used by the notification system. No sample data.
