 ...
 *
 */
class ehSettingsController extends ehBaseController
{
    /**
...
//        }
        ...
        if (empty($setting->id)) {
            ...
            $form['layout']['form_action'] = config('app.url').'/settings/create';
            $form['layout']['form_method'] = 'get';
        } else {
            // Record 1 already exists so just use a normal update.
            $form['layout']['form_action'] = config('app.url').'/settings/'.$setting->id;
    ...
    public function update(Request $request, ehSetting $setting)
    {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////
        // NOTE: if you just redirect to /settings here the index() method redirects
