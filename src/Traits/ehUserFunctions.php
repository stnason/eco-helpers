...
trait ehUserFunctions
{
    ...
    /**
     * Return the user's default role's default_home_page.
     * @param $user_id
     * @return string
     */
    ...
    public function setActingRole($acting_role_id, $popup=true) {
        ...
        //TODO: Does this need to move to either the ehNotification model or a new ehNotifications Class. (see getActingRole)
        // and maybe (??) the ehNotificationsController is not a controller at all (?), but a Class? (Too many questions...)
        ...
        if ($popup) {
            ...
            ehNotificationsController::newNotification($notification);
        }
    ...
    //TODO: these 2 functions should most probably reside in a trait of their own.
    // based on the responsibility of this trait to answer and manage questions about role access.
    ...
    /**
     * Base64 image date for the "no user phone" image.
     * @var string
     */
    protected static $na_image_data = '
